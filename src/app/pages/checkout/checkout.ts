...
@Component({
  ...
  imports: [BackButton, ShippingForm, PaymentForm, SummarizeOrder , MatButtonModule],
  template: `
  <div class="mx-auto max-w-[1200px] py-6">
    <app-back-button class="mb-4" navigateTo="/cart">العودة إلى السلة</app-back-button>

    <h1 class="text-3xl font-extrabold mb-4">إتمام الطلب</h1>
      ...
      <div class="lg:col-span-2">
        <app-summarize-order>
            ...
            <ng-container actionButtons>
              ...
              {{store.loading() ? 'جارٍ المعالجة...' : 'تأكيد الطلب'}}
            </button>
            </ng-container>
        </app-summarize-order>
      </div>
